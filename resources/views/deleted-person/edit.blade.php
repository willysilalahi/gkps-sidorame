                        ...
                        <form class="row g-3" method="POST" action="{{ route('person_edit_patch', $person->id) }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="baptis" class="form-select">
                                    <option value="" @if ($person->baptis == null) selected @endif>Pilih
                                    </option>
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="sidi" class="form-select">
                                    <option value="" @if ($person->sidi == null) selected @endif>Pilih
                                    </option>
                                    <option value="1" @if ($person->sidi == 1) selected @endif>Sudah Sidi
                                    </option>
                                    <option value="0" @if ($person->sidi === 0) selected @endif>Belum Sidi
                                    </option>
                                </select>
                            </div>
                            <div class="col-md-6">
